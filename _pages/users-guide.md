...
- **Translation tables** can be set per organism using the _'Details'_ panel: to replace the translation table (default or set by admin) for any given organism, enter a different table identifier in the field labeled as _'Non-default Translation Table'_.
